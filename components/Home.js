...
function Home () {
  return (
    <View>
    <View>
      <Text style={{marginLeft:'10%',fontWeight:'bold',marginTop:'2%',color: "#000000", fontSize: 18}}>Welcome back</Text>
      <Text style={{ marginLeft:'10%',fontWeight:'bold',color: "#000000", fontSize: 18,marginBottom:'2%'}}>Seller Company</Text>
      <Image style={{width: 40,height: 40,borderRadius: 40 / 2,backgroundColor:'#D9D9D9',marginRight:'0%',position:'absolute'}}
          source={{
            uri:
    ...
    <View style={{borderWidth: 6,height:'20%',borderColor:'#D9D9D9'}}>
      ...
      <Text style={{marginTop:'2%',fontWeight:'bold',color: "#000000",marginLeft:'12%'}}>To do list</Text>
      {/* ?<Dropdown label="Stats" data={data}/> */}
      </View>
      <View style={{marginTop:'10%',width:'100%',flexDirection: 'row',justifyContent: 'space-evenly',borderColor:'#D9D9D9'}}>
        <View style={{ borderWidth: 4,borderColor:'#D9D9D9',paddingLeft:'3%',paddingRight:'3%',paddingVertical:'1%'}}>
          <Text style={{fontWeight:'bold',marginTop:'2%',color: "#000000"}}>Pending orders</Text>
          <Text style={{fontWeight:'bold',marginTop:'2%',color: "#000000",textAlign: "center"}}>0</Text>
        </View>
        <View style={{ borderWidth: 4,borderColor:'#D9D9D9',paddingLeft:'4%',paddingRight:'4%',paddingVertical:'1%'}}>
          <Text style={{fontWeight:'bold',marginTop:'2%',color: "#000000",}}>Out of Stock</Text>
          <Text style={{fontWeight:'bold',marginTop:'2%',color: "#000000",textAlign: "center"}}>0</Text>
        </View>
        <View style={{ borderWidth: 4,borderColor:'#D9D9D9',paddingLeft:'4%',paddingRight:'4%',paddingVertical:'1%'}}>
          <Text style={{fontWeight:'bold',marginTop:'2%',color: "#000000"}}>Low on Stock</Text>
          <Text style={{fontWeight:'bold',marginTop:'2%',color: "#000000",textAlign: "center"}}>0</Text>
        </View>
      </View>
    </View>
    <View>
      <View>
      <Text style={{marginTop:'4%',fontSize:18,fontWeight:'bold',height:'9%',color:'#000000'}}>Bussiness Insights</Text>
      <View>
      <View style={{height :'58%',borderWidth: 6,backgroundColor:'#D9D9D9',paddingLeft:'4%',paddingRight:'4%',paddingVertical:'1%',borderColor:'#D9D9D9'}}>
       <Text style={{fontSize:40,textAlign: "center",color:'#000000'}}>Graph</Text>
       </View>
      <View style={{justifyContent:'space-evenly',height :'20%',borderWidth: 6,backgroundColor:'#ffffff',paddingLeft:'4%',paddingRight:'4%',paddingVertical:'1%',borderColor:'#ffffff',flexDirection:'row',justifyContent: 'space-evenly'}}>
      <View style={{alignSelf:'baseline',width:'49%', borderWidth: 4,borderColor:'#D9D9D9',paddingLeft:'3%',paddingRight:'3%',paddingVertical:'1%'}}>
          <Text style={{marginLeft:'7%',fontWeight:'bold',marginTop:'2%',color: "#000000"}}>Views</Text>
          <View style={{ flexDirection:'row',justifyContent:'space-around'}}>
          <Text style={{fontWeight:'bold',marginTop:'2%',color: "#000000"}}>0000</Text>
          <Text style={{fontWeight:'bold',marginTop:'2%',color: "green"}}>0.37%</Text>
        </View>
        </View>
        <View style={{ marginLeft:'6%',alignSelf:'baseline',width:'49%',borderWidth: 4,borderColor:'#D9D9D9',paddingLeft:'4%',paddingRight:'4%',paddingVertical:'1%'}}>
          <Text style={{marginLeft:'7%',fontWeight:'bold',marginTop:'2%',color: "#000000"}}>Orders</Text>
          <View style={{flexDirection:'row',justifyContent:'space-around'}}>
          <Text style={{fontWeight:'bold',marginTop:'2%',color: "#000000"}}>0000</Text>
          <Text style={{fontWeight:'bold',marginTop:'2%',color: "green"}}>0.37%</Text>
        </View>
