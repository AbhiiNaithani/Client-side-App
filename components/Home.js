...
function Home () {
  return (
    ...
    <View >
      ...
      <View>
      <Image style={{width: wp*0.1,height: hp*0.06,borderRadius:0.025,marginTop:'2%',backgroundColor:'#D9D9D9'}}
          source={{
            uri:
    ...
    <View style={{borderWidth: 6,height:'20%',borderColor:'#D9D9D9'}}>
      ...
      <View style={{marginTop:'5%',width:'100%',flexDirection: 'row',justifyContent: 'space-evenly',borderColor:'#D9D9D9'}}>
    ...
    <View>
      <View>
      <Text style={{margin:'4%',fontSize:18,fontWeight:'bold',height:'9%',color:'#000000'}}>Bussiness Insights</Text>
      <View>
      <View style={{height:wp*0.57,borderWidth: 6,backgroundColor:'#D9D9D9',paddingLeft:'4%',paddingRight:'4%',paddingVertical:'1%',borderColor:'#D9D9D9'}}>
